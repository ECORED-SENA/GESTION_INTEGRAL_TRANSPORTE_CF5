...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4 La participación del mercado y su distribución está conformada por la clase de competencia existente y los factores que lo determinan, tal como se puede observar en la siguiente imagen.
    ...
    .row.justify-content-center.mb-4
      .col-md-10
        figure
          img(src='@/assets/curso/tema2/tabla1.jpg', alt='Señal de bien con la mano')
    separador
